...
<form action ="index.php?option=settings" method="post" name="settings">
	...
	<table>
	<tr><td colspan="3"><span class="header">:: Settings</span></td></tr>
	...
	<tr class="header"><td colspan="3">&nbsp;</td></tr>
	<tr class="header"><td>Option</td><td>Value</td><td>Description</td></tr>
	...
	<tr><td>avatars</td><td width="300"><input style="width: 300px" type="text" name="avatars" value="<?php echo $avatars;?>"></td><td>Seperate with comma. Example: <i>image1.gif,image2.gif,image3.gif</i><br>Upload all images to <i>/avatars/</i> folder.</td></tr>	
	...
	<tr><td>admin</td><td><input type="text" style="width: 300px" name="admin" value="<?php echo $admin;?>"></td><td>Lowercase only, Seperate with comma. Example: <i>user1,user2,user3</i></td></tr>
	<tr><td>moderator</td><td><input type="text" style="width: 300px" name="moderator" value="<?php echo $moderator;?>"></td><td>Lowercase only, Seperate with comma. Example: <i>user1,user2,user3</i></td></tr>
	<tr><td>speaker</td><td><input type="text" style="width: 300px" name="speaker" value="<?php echo $speaker;?>"></td><td>Lowercase only, Seperate with comma. Example: <i>user1,user2,user3</i></td></tr>
