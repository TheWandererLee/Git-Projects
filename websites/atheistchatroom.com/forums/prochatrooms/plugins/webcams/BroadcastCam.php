...
if(!validStreamID($_SESSION['myStreamID']))
{
	...
	// Something happened that caused this to always throw when RELOADING THE PAGE. Stream ID might not be correctly inputting into database
	// or something was modified causing a PHP file to fail that later on would've modified the stream ID correctly.
}

// update streamID
$_SESSION['myStreamID'] = streamID(); // This also glitched out
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">	
    ...
    <body> <!-- onload="window.prompt('Copy','<?php echo $_SESSION['myStreamID'];?>');" <!--Was used for showing users streamID on page load-->
