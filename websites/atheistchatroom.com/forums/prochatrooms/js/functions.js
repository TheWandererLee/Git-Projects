...
function optionsMenu(ndiv,nBar,nContainer,nWin)
{
	...
	document.getElementById(ndiv).innerHTML += '<span alt="'+lang62+'" title="'+lang62+'" id="share" class="iconShare" onclick=\'showInfoBox("shareFiles","280","300","200","plugins/share/","");\'></span>';
	
	document.getElementById(ndiv).innerHTML += '<span alt="Grab the mic" title="Grab the mic" id="micgrab" class="iconMicgrab" onclick=\'grabTheMic();\'></span>';
