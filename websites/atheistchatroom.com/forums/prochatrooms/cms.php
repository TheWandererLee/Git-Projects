...
$phpbb_root_path = (defined('PHPBB_ROOT_PATH')) ? PHPBB_ROOT_PATH : '/home/content/73/3680573/html/forums/';
...
{
   define('C_CUSTOM_USERNAME',$user->data['username']); // username
   define('C_CUSTOM_USERID',$user->data['user_id']); // userid
}
else
{
       die("Please login from the forum.");
}
