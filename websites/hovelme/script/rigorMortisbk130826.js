cVars['rigorMortisModule']['$'] = new function() { // Initiate namespace
    var cg, realFps, fps, mouse, yankTimer;
    var keyvx=0, keyvy=0, keyvb = []; // Move vector x, move vector y, key vector bank [stores keys pressed to avoid repeats]
    var mVars = cVars['rigorMortisModule']; // Bring over module variables from main site. This is a pointer
    
    var HUDsize = 96; // Static set global variables
    ...
    cVars['simulatedLag'] = 200; // Can be set above 0 to simulate network lag each-way
