...
<body <?php body_class(); ?> style="background: url(../images/layout/bg.png) repeat-x #23504D fixed;">
<!-- Page -->
<div id="page">
	<!-- Header -->
	<div id="header">
		...
		<div id="logo">
			...
			<div class="description" style="color: #333; font-weight: bold; text-shadow: #FFF 0px 1px 1px; font-size: 1.5em;"><?php bloginfo('description'); ?></div>
		</div>
		<!-- END Logo -->
		<!-- Main Navigation -->
		<div id="nav">
