...
function dtgenInit() { // ALL THESE ID'S (e.g. option_oc[ID]) MUST BE CORRECTLY ASSOCIATED WITH THE NAME OF ITS INPUT OR SCRIPT WILL FAIL
    if (document.getElementsByName('option_oc[255]') && document.getElementsByName('option_oc[255]').length == 1) { // Double tag IDs
      ...
      // These should all be .png files and stored in the same folder. If the ID becomes disassociated, it can be fixed here.
      var dtgenIDs = [];
      dtgenIDs[0] = [166,165,164,88,89,90,91,92,93,94,95,97];
      dtgenIDs[1] = ['si_black','si_blue','si_blue_gitd','si_clear','si_olive_green','si_green_gitd','si_orange','si_pink','si_purple','si_red','si_white','si_yellow'];
      ...
      // These should all be .png files and stored in the same folder. If the ID becomes disassociated, it can be fixed here.
      var dtgenIDs = [];
      dtgenIDs[0] = [177,176,175,83,72,73,74,75,76,77,78,180];
      dtgenIDs[1] = ['si_black','si_blue','si_blue_gitd','si_clear','si_olive_green','si_green_gitd','si_orange','si_pink','si_purple','si_red','si_white','si_yellow'];
...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-box-heading"><div class="mijoshop_heading"><?php echo $heading_title; ?></div></div>
  ...
  <div class="product-info">
    ...
    <?php } ?>
        ...
        <?php } ?>
      <?php if ($price) { ?>
       <div class="product-price">FROM JUST
        <?php if (!$special) { ?>
        ...
        <?php } ?>
      <?php } ?>
     <div class="shop-desc">    <?php echo MijoShop::get('base')->triggerContentPlg($description); ?>
</div>
  ...
  <tr>
    <td align="center" valign="top">
            <?php foreach ($option['option_value'] as $option_value) { ?>
              <table class="option-image-css" width="200" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="60" rowspan="2"><label for="option-value-<?php echo $option_value['product_option_value_id']; ?>"><img src="<?php echo $option_value['image']; ?>" alt="<?php echo $option_value['name'] . ($option_value['price'] ? ' ' . $option_value['price_prefix'] . $option_value['price'] : ''); ?>" /></label></td>
    <td width="150">
    <input type="radio" name="option_oc[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" id="option-value-<?php echo $option_value['product_option_value_id']; ?>" />
  ...
  <tr>
    ...
    <?php if ($option_value['price']) { ?>
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <b><?php echo $option['name']; ?>:</b><br />
          <input name="option_oc[<?php echo $option['product_option_id']; ?>]" type="text" value="<?php echo $option['option_value']; ?>" size="30" maxlength="13" />
        </div></div>
        <br />
        <?php } ?>
...
<?php } ?>
  ...
  <div id="tab-comments" class="tab-content">
      ...
      if ($_jcomments == 'komento' && file_exists($komento)) {
          ...
          $p_options = array('params' => new JParameter(''));
