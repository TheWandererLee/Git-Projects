...
<div id="newheader"><h1>East Coast Moving, LLC</h1></div>
...
<div id="main">
	...
	<div class="content full" style="text-align: justify">
		...
		<br /><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Cathy<!-- Jones--></span>
		<hr size="1" width="684" />
		June 21, 2013
		<br>“Carrie,
		...
		<br /><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Susan & Gary<!-- Leonard--></span>
		<hr size="1" width="684" />
		June 30, 2013
		...
		<br /><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Anthony & Mary Ann<!-- Crimi--></span>
		<hr size="1" width="684" />
		June 15, 2012
		...
		<br /><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Bill<!-- Ratliff--></span>
		<hr size="1" width="684" />
		May 9, 2012
		...
		<br /><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Elizabeth<!-- Highfill--></span>
		<hr size="1" width="684" />
		March 16, 2012
		...
		<br /><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Christine<!-- Harvey--></span>
		<hr size="1" width="684" />
		Thank you for your feedback, advice and...honesty.
		<br /><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Phil<!-- Esposito--></span>
		<hr size="1" width="684" />
		...
		<br /><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Joe &amp; Lenore<!-- Gusten-->, Pfafftown, NC</span>
		<hr size="1" width="684" />
		"You guys sure helped make this easier for me. Everything is unpacked and was in wonderful condition."
		<br /><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Barbara<!-- Beauclerke-->, Simpsonville, SC</span>
		<hr size="1" width="684" />
		"I can’t say enough... consider it efficient, professional, clean and superior."
		<br /><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Lynda<!-- Herrick-->, Ocean Isle Beach, NC</span>
		<hr size="1" width="684" />
		"Using East Coast made my moving experience stress free."
		<br /><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Cheryl<!-- Lovaty-->, Little River, SC</span>
		<hr size="1" width="684" />
		...
		<br /><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Regina<!-- Murphy-->, Mill Creek, WA</span>
		<hr size="1" width="684" />
...
<div class="right" style="margin-top:8px">
	<iframe src="contact.php" class="content-right" style="width: 496px" width="496" height="386">Sorry, your browser does not support the iFrame contact form.<br>Please <a href="mailto:eastcoastmvg@atmc.net">email us</a> instead!</iframe>
				...
				<?php } else { ?>
	<div class="content" style="margin: 8px 0 32px">
		<b><span style="font-size: larger;">Our office has moved!</span><br><a href="/contactus">See the new address on the contact page!</a></b>
	</div>
