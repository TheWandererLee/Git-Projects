...
<div id="main">
	...
	<div class="content full" style="text-align: justify">
		...
		March 2, 2015
		<br>“Excellent Job!”
		<br><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Jeff (Sunset Beach, NC)</span>
		<hr size="1" width="684" />
		March 17, 2015
		<br>“Great Job! Will refer for sure!”
		<br><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Elaine (Wilmington, MA)</span>
		<hr size="1" width="684" />
		March 19, 2015
		<br>“Great job – very efficient””
		<br><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Anna (Ocean Isle Beach, NC)</span>
		<hr size="1" width="684" />
		March 23, 2015
		<br>“The men did excellent work. We appreciated it very much.”
		<br><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Kathleen (Cherry Valley, NY)</span>
		<hr size="1" width="684" />
		March 25, 2015
		<br>“Very Professional!”
		<br><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Maryann (Ocean Isle Beach, NC)</span>
		<hr size="1" width="684" />
		March 27, 2015
		<br>“A++ outstanding, very helpful   Explained Everything”
		<br><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Bill (Ocean Isle Beach, NC)</span>
		<hr size="1" width="684" />
		February 25, 2015
		<br>“Jeff, Keith & Tom were extremely helpful. They didn’t waste any time and were very pleasant.”
		<br><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Janet (Sunset Beach, NC)</span>
		<hr size="1" width="684" />
		February 23, 2015
		<br>“Best movers ever! (and we move a lot….) The crew worked hard (very hard) and they got more done in ½ day then most full days. When we move again we will use East Coast. And will recommend. Thank you for a great day.”
		<br><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Carol (Ocean Isle Beach, NC)</span>
		<hr size="1" width="684" />
		February 13, 2015
		<br>“Professional, timely, steady pace, Exceeded expectations”
		<br><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — James (Supply, NC)</span>
		<hr size="1" width="684" />
		February 7, 2015
		<br>“Excellent job, very friendly”
		<br><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Wendy (East Haven, CT)</span>
		<hr size="1" width="684" />
		February 6, 2015
		<br>“Great guys Awesome job”
		<br><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — David (Wilbraham, MA)</span>
		<hr size="1" width="684" />
		February 6, 2015
		<br>“Awesome workers!”
		<br><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Robin (Calabash, NC)</span>
		<hr size="1" width="684" />
		October 22, 2014
		<br />“These guys did a great job; we appreciate their manners and that they never stopped.”
		<br /><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — John (North Myrtle Beach, SC)</span>
		<hr size="1" width="684" />
		September 29, 2014
		<br />“Outstanding job, took great care in condition of house and moved items!”
		<br /><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Jim (Shallotte, NC)</span>
		<hr size="1" width="684" />
		September 22, 2014
		<br />“The best moving experience I've ever been part of.  Excellent service and wonderful personnel.”
		<br /><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Mary (Patchogue, NY)</span>
		<hr size="1" width="684" />
		September 19, 2014
		<br />“Chris and Paul did an awesome job.  They arrived early which made our travel needs come together.  They were courteous, helpful and fun.  They made a stressful experience easier for us!”
		<br /><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Scott (Bolivia, NC)</span>
		<hr size="1" width="684" />
		September 19, 2014
		<br />“Very efficient and friendly.  Great Job!!”
		<br /><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Jennifer (Shallotte, NC)</span>
		<hr size="1" width="684" />
		September 12, 2014
		<br />“Awesome job, best mover I ever had.”
		<br /><span style="font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp; — Margaret (Congers, NY)</span>
		<hr size="1" width="684" />
...
<div class="blank right" style="width: 383px; height: 229px; box-shadow: 2px 2px 8px #000;">
	<img src="images/pictures/checkingcabinet-1.jpg" />
				...
				<div class="full content" style="margin-top: 16px; text-align: justify;"><h2 style="font-style: italic"><span style="color: #0070C0">PEOPLE'S CHOICE #1 COMPANY IN BRUNSWICK COUNTY '08, '09, '10, '11, '12, '13, '14 &amp; '15</span>
...
<div class="right" style="margin-top:8px">
	...
	<div class="content-right" style="text-align: justify; width: 400px; text-shadow: 1px 1px 2px rgba(0,0,0,0.4);">
		...
		<a href="images/firstPlace2015.pdf"><img src="images/bestOfBrunswick2015.gif" style="float:left">
	...
	<div class="blank content tilt" style="overflow: hidden; box-shadow: -2px -2px 10px #000;">
		...
		<div id="slider-wrapper">
			<div id="slider" class="nivoSlider">
			    ...
			    <?php
				    for ($i=1;$i<=21;$i++) { echo '<img src="images/gallery/pic'.($i<=9?'0':'').$i.'.jpg" alt="" />' . "\n"; }
			    ?>
