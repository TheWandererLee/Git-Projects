...
function exposeAddSlide(opts, els) {
	opts.addSlide = function(newSlide, prepend) {
		...
		if (opts.pager || opts.pagerAnchorBuilder)
			jQuery.fn.cycle.createPagerAnchor(els.length-1, s, $(opts.pager), els, opts);
...
function buildPager(els, opts) {
	...
	jQuery.each(els, function(i,o) {
		jQuery.fn.cycle.createPagerAnchor(i,o,$p,els,opts);
	});
	opts.updateActivePagerLink(opts.pager, opts.startingSlide, opts.activePagerClass);
};

jQuery.fn.cycle.createPagerAnchor = function(i, el, $p, els, opts) {
	var a;
...
// don't need.
//
jQuery.fn.cycle.transitions.none = function($cont, $slides, opts) {
...
jQuery.fn.cycle.transitions.fadeout = function($cont, $slides, opts) {
...
// blindX
jQuery.fn.cycle.transitions.blindX = function($cont, $slides, opts) {
...
// blindY
jQuery.fn.cycle.transitions.blindY = function($cont, $slides, opts) {
...
// blindZ
jQuery.fn.cycle.transitions.blindZ = function($cont, $slides, opts) {
	var h = $cont.css('overflow','hidden').height();
	var w = $cont.width();
	opts.before.push(function(curr, next, opts) {
		jQuery.fn.cycle.commonReset(curr,next,opts);
...
jQuery.fn.cycle.transitions.growX = function($cont, $slides, opts) {
	opts.before.push(function(curr, next, opts) {
		jQuery.fn.cycle.commonReset(curr,next,opts,false,true);
...
jQuery.fn.cycle.transitions.growY = function($cont, $slides, opts) {
	opts.before.push(function(curr, next, opts) {
		jQuery.fn.cycle.commonReset(curr,next,opts,true,false);
...
jQuery.fn.cycle.transitions.curtainX = function($cont, $slides, opts) {
	opts.before.push(function(curr, next, opts) {
...
jQuery.fn.cycle.transitions.curtainY = function($cont, $slides, opts) {
	opts.before.push(function(curr, next, opts) {
...
jQuery.fn.cycle.transitions.cover = function($cont, $slides, opts) {
...
jQuery.fn.cycle.transitions.uncover = function($cont, $slides, opts) {
	var d = opts.direction || 'left';
	var w = $cont.css('overflow','hidden').width();
	var h = $cont.height();
	opts.before.push(function(curr, next, opts) {
...
jQuery.fn.cycle.transitions.toss = function($cont, $slides, opts) {
...
// wipe - clip animation
jQuery.fn.cycle.transitions.wipe = function($cont, $slides, opts) {
	var w = $cont.css('overflow','hidden').width();
	var h = $cont.height();
	opts.cssBefore = opts.cssBefore || {};
	var clip;
