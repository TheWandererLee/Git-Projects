...
$chart[ 'chart_data' ] = array ( array ( "", "Tracks","Comments","Previews","Deleted","Managers","SOLs" ), array ( "Amount", $num[0],$num[1],$num[2],$num[3],$num[4],$num[5] ) );//, array ( "Size", $num[7],$num[8],$num[9],$num[10],$num[11],$num[12] ) );
...
$chart[ 'legend_rect' ] = array ( 'x'=>0, 'y'=>16, 'width'=>350, 'height'=>50, 'margin'=>20, 'fill_color'=>"000000", 'fill_alpha'=>0, 'line_color'=>"000000", 'line_alpha'=>0, 'line_thickness'=>0 ); 
$chart[ 'legend_transition' ] = array ( 'type'=>"dissolve", 'delay'=>0, 'duration'=>1 );

$chart[ 'series_color' ] = array ("66cccc"); 
