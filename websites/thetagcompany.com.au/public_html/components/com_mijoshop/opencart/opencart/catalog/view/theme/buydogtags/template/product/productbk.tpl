...
function dtgenInit() { // ALL THESE ID'S (e.g. option_oc[ID]) MUST BE CORRECTLY ASSOCIATED WITH THE NAME OF ITS INPUT OR SCRIPT WILL FAIL
    <?php
        ...
        $chains = array();
        $texts = array();
        if (count($texts)>9) $doubleTag = true; else $doubleTag = false;
        ...
        while ($eol < strlen($data)) {
            ...
            if ($op[1] == $thisProduct) {
                ...
                if ($op[0] == 'tag') {
                    $tags[] = array($op[2],'dt_'.$op[3]); // ID, Tag Metal Name
                }
        ...
        echo 'var dtgenDoubleTag='.($doubleTag?'true':'false').';'.$nl;
    ...
    function tag1Changed() {
      ...
      if (typeof dtgenIDt[5] != 'undefined' && document.getElementsByName(dtgenIDt[5])[0]) { document.getElementById('dtgen1Text').innerHTML += '<br>' + parseText(document.getElementsByName(dtgenIDt[5])[0].value); }
    }
    ...
    function tag2Changed() {
      ...
      if (typeof dtgenIDt[10] != 'undefined' && document.getElementsByName(dtgenIDt[10])[0]) { document.getElementById('dtgen1Text').innerHTML += '<br>' + parseText(document.getElementsByName(dtgenIDt[10])[0].value); }
    }
    ...
    if (typeof dtgenIDt != 'undefined') {
        function dtgenInputAdjust() {
          ...
          if (typeof dtgenIDt[5] != 'undefined') document.getElementsByName(dtgenIDt[5])[0].value = document.getElementsByName(dtgenIDt[5])[0].value.replace(/ /g,"_");
          ...
          if (dtgenDoubleTag) {
            ...
            document.getElementsByName(dtgenIDt[10])[0].value = document.getElementsByName(dtgenIDt[10])[0].value.replace(/ /g,"_");
          }
        }
        function dtgenInputReady() {
          ...
          document.getElementsByName(dtgenIDt[5])[0].value = document.getElementsByName(dtgenIDt[4])[0].value.replace(/_/g," ");
          ...
          if (dtgenDoubleTag) {
            ...
            document.getElementsByName(dtgenIDt[10])[0].value = document.getElementsByName(dtgenIDt[10])[0].value.replace(/_/g," ");
          }
        }
        ...
        if (typeof dtgenIDt[5] != 'undefined') document.getElementsByName(dtgenIDt[5])[0].addEventListener("keyup", tag1Changed, false);
        ...
        if (typeof dtgenIDt[5] != 'undefined') document.getElementsByName(dtgenIDt[5])[0].addEventListener("change", tag1Changed, false);
        ...
        */
        if (dtgenDoubleTag) {
          ...
          if (typeof dtgenIDt[10] != 'undefined') document.getElementsByName(dtgenIDt[10])[0].addEventListener("change", tag1Changed, false);
          ...
          if (typeof dtgenIDt[10] != 'undefined') document.getElementsByName(dtgenIDt[10])[0].addEventListener("keyup", tag1Changed, false);
          /*
  ...
  <tr>
    ...
    <?php if ($option['type'] == 'datetime') {
      ...
      <div id="dtgenDisplay" style="position:relative;display:block;height:320px;width:280px;float:left">
        ...
        <span id="dtgen<?php echo $dtgenInc; ?>Text" style="position:absolute; left:72px; top: 32px; font-size: 18px; line-height: 20px; font-weight: bold; color: #CCC;<?php echo (isset($textFont)?' font-family: \'customFont\', Courier New, Courier, sans-serif;':' font-family: Courier New, Courier, sans-serif;'); ?> text-shadow: -1px 1px 1px rgba(0,0,0,0.6), 1px -1px 1px rgba(255,255,255,0.8)"><!--Default<br>Text<br>Line3<br>Line4<br>Text--></span>
