...
<!--
var mySlide1,mySlide2,mySlide3,mySlide4,mySlide5,mySlide6;
...
window.addEvent('domready', function() {
	...
	function hideAllPagesExcept(thisPage) {
		for (var i=1;i<=6;i++) {
			//$('page'+i).style.visibility = i==thisPage?"visible":"hidden";
			//$('page'+i).parentNode.style.visibility = i==thisPage?"visible":"hidden";
			//console.log("Hid page "+i+"\r\n"+$('page'+i).parentNode.nodeName+"\r\nTo: "+(i==thisPage?"visible":"hidden"));
		}
	}
	
	<?php if (stristr($_SERVER['HTTP_HOST'],'divine') !== false) { ?>
		mySlide1.hide();
		mySlide4.slideIn();
...
<div style="position: relative;">
        ...
        <div id="page3"> <!-- Distributors -->
        	<div style="float: left; width: 50%">
                ...
                <ul>
                    ...
                    <li><a href="http://www.forevermarkcabinetry.com">Forever Mark Cabinetry</a></li>
                </ul>
                <h1 class="listHeader">Countertops</h1>
                <ul>
			<li><a href="http://www.schneiderstone">Schneider Stone</a></li>
                    <li>Granite</li>
    ...
    <div style="position: absolute; top: 0px;">
        ...
        <tr><td>
            ...
            Contact me to schedule your in-home consultation. Appointments only 910-294-1025<!--910-470-2470-->
    ...
    <!--<div style="position: absolute; top: 0px;">
    	<div id="page7" width="100%">
        	<span style="font-size: 12px">
                ...
                <br />With all of these flooring choices, you may want to enlist the services of our professional design specialist, who is ready to assist you. In fact, we will be there every step of the way with our reputable, honest, personalized service.
                <br />From hardwood floor installation to ceramic tile installation to carpet installation, you can depend on the skilled craftsmanship of our installers. Plus, all of our hardwood floors, engineered hardwood floors, laminate floors, floor tile, and carpets come with exceptional manufacturers' warranties.
                <br />Whether you are in visiting beautiful Southport or live in Brunswick County, or anywhere in the area, contact us for a free estimate at (910) 454-8745. Stop by our showroom today and find out why we're better than any big box or flooring stores in Brunswick County.
            </span>
        </div>
    </div>-->
</div>
...
Copyright &copy;2015 Divine Designs | <a href="mailto:elitewoodclassics@eastnc.twcbc.com">Email Us</a> | Phone: (910) 454-8745<br />
